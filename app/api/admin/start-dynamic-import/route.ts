...
export async function POST(req: Request) {
    try {
        ...
        const { categoryUrl, jobId, pageNum, delayMin, delayMax, mode, linkSelector, extractSelectors, platformUser, platformPassword, regionFilter } = payload;
        ...
        const res = await fetch(`${microserviceUrl}/api/run-dynamic-scrape`, {
            ...
            body: JSON.stringify({
                ...
                immofluxPass: platformPassword || process.env.IMMOFLUX_PASS || 'EDwohI#6Oi',
