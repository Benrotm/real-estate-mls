...
import {
    Plus, Filter, Phone, Mail, Calendar,
    ArrowUpRight, User, MessageSquare, CheckCircle, Clock, Edit
} from 'lucide-react';
...
import RecommendClientButton from '@/app/components/dashboard/RecommendClientButton';
...
export default async function AdminLeadsPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 pb-10 md:pb-20">
            <NotificationSync types={['lead', 'inquiry', 'offer']} />
            
            {/* Header Stripe */}
            <div className="bg-white border-b border-slate-200 sticky top-0 z-10">
                <div className="max-w-7xl mx-auto px-1 sm:px-6 lg:px-8 py-2 md:py-4">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div>
                            <h1 className="text-xl md:text-2xl font-bold text-slate-900">All Leads Management (Admin)</h1>
                            <p className="text-slate-500 text-xs md:text-sm">Super Admin view of all system leads.</p>
                        </div>
                        <div className="flex items-center gap-3">
                            ...
                            <RecommendClientButton userId={user.id} />
