                ...
                <div className="space-y-6 text-slate-600 text-sm leading-relaxed">
                    ...
                    <div>
                        ...
                        <ul className="list-disc pl-5 space-y-2 bg-slate-50 p-4 rounded-xl border border-slate-100">
                            ...
                            <li><strong>City:</strong> Must be an exact text match.</li>
                            <li><strong>Neighborhood / Area:</strong> The property must physically fall inside the lead's drawn map polygon, OR its area text must match one of the lead's preferred areas.</li>
                            ...
                            <li><strong>Surface / Area (sqm):</strong> If the property's usable area is outside the Lead's Min/Max range (accounting for the margin %), it scores 0.</li>
                    ...
                    <div className="pt-4">
                        ...
                        <p className="mb-3">
                            All other criteria (Floor, Year Built, Bathrooms, Comfort, Furnishing, Features) are treated as bonuses. They <strong>never</strong> disqualify a property or drop the score to 0. 
                        </p>
                        <ul className="list-disc pl-5 space-y-2 bg-slate-50 p-4 rounded-xl border border-slate-100">
