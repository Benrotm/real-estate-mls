...
export default function CreditSettingsPage() {
    ...
    const aiTools = [
        ...
        { key: 'ai_panorama_360', title: 'Tur Virtual 360° Panoramic per Cameră', icon: Wand2 },
        { key: 'ai_walkthrough_2stage', title: 'Walkthrough 2-Stage (Plan → Render Interior → Video)', icon: Wand2 },
        { key: 'ai_walkthrough_isometric', title: 'Tur Video Izometric 3D (Fly-Through din Schiță)', icon: Wand2 },
        { key: 'ai_walkthrough_video', title: 'Video Walkthrough 3D Standard (5–8 sec)', icon: Wand2 },
        { key: 'ai_walkthrough_video_extended', title: 'Video Walkthrough 3D Extins (10–15 sec)', icon: Wand2 },
