                ...
                {isSuperAdmin && (
                    <section className="mb-12">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <div>
                                <h2 className="text-xl font-bold">Access Control & Security</h2>
                                <p className="text-sm text-slate-400">Manage user role definitions and system capabilities matrix.</p>
                            </div>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <Link href="/dashboard/admin/permissions" className="bg-slate-900/50 p-6 rounded-2xl border border-slate-800 hover:border-indigo-500 hover:bg-indigo-500/5 transition-all group">
