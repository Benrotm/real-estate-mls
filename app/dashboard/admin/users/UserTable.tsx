...
import { Users, Shield, Database, LayoutGrid } from 'lucide-react';
                                ...
                                <td className="p-4">
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 font-bold border border-slate-700">
                                            {user.full_name ? user.full_name[0] : <Users size={16} />}
                                        </div>
                                        <div>
                                            ...
                                            <div className="text-xs text-slate-500">
                                                {user.email?.email || 'ID: ' + user.id.slice(0, 8) + '...'}
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td className="p-4">
                                    <div className="flex items-center gap-2">
                                        ...
                                        {user.bonus_listings > 0 && (
                                            <span className="text-xs text-purple-400 bg-purple-500/10 px-1.5 py-0.5 rounded border border-purple-500/20">
