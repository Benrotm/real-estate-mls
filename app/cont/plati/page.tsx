...
export default function PlatiPage() {
    ...
    return (
        <div className="max-w-4xl mx-auto px-2 sm:px-6 py-4 md:py-6 space-y-6">
                ...
                <div className="space-y-2.5 w-full md:w-auto">
                    <div className="flex items-center gap-3 mb-1">
                        <Link 
                            ...
                            className="inline-flex items-center gap-1.5 text-xs font-bold text-orange-400 hover:text-orange-300 transition-colors bg-orange-500/10 px-2.5 py-1 rounded-lg border border-orange-500/20"
                        >
                    ...
                    <section className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-5 gap-2.5 sm:gap-4">
                            {PACKAGES.map((pack) => (
                                <div 
                                    key={pack.credits}
                                    className={`bg-slate-900 border rounded-2xl p-3.5 sm:p-5 flex flex-col justify-between gap-3 sm:gap-4 transition-all relative ${
                                        pack.popular 
                                ...
                                >
                                    {pack.popular && (
                                        <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-yellow-500 text-black text-[8px] sm:text-[9px] font-black uppercase tracking-wider px-2 py-0.5 rounded-full whitespace-nowrap">
                                            Recomandat
                                        </span>
                                    )}
                                    <div className="space-y-0.5 sm:space-y-1">
                                        <div className="text-[10px] sm:text-xs text-slate-500 font-bold uppercase truncate">{pack.name}</div>
                                        <div className="text-xl sm:text-3xl font-black text-white flex items-baseline gap-1 font-mono">
                                            {pack.credits}
                                            <span className="text-[10px] sm:text-xs text-yellow-500 font-bold">CR</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-2 sm:space-y-3">
                                        ...
                                        <button
                                            ...
                                            className={`w-full font-bold py-1.5 sm:py-2 rounded-xl text-[11px] sm:text-xs transition-colors ${
                                                pack.popular 
                            ...
                            <div className="col-span-2 sm:col-span-1 lg:col-span-1 bg-slate-900 border border-slate-800 hover:border-slate-700 rounded-2xl p-3.5 sm:p-5 flex flex-col justify-between gap-3 sm:gap-4 transition-all hover:-translate-y-0.5 relative">
                                <div className="space-y-0.5 sm:space-y-1">
                                    <div className="text-[10px] sm:text-xs text-slate-500 font-bold uppercase">Pachet Custom</div>
                                    <div className="text-xl sm:text-3xl font-black text-white flex items-baseline gap-1 font-mono">
                                        Custom
                                    </div>
                                </div>
                                ...
                                <div className="space-y-2 sm:space-y-3">
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full bg-slate-950 border border-slate-800/80 rounded-xl pl-3 pr-8 py-1.5 sm:py-2 text-xs font-mono text-white outline-none focus:border-yellow-500 transition-colors"
                                        />
                                    ...
                                    <button
                                        ...
                                        className="w-full font-bold py-1.5 sm:py-2 rounded-xl text-[11px] sm:text-xs bg-slate-800 hover:bg-slate-700 text-white border border-slate-700 transition-colors"
                                    >
                                        Cumpără Custom
                                    </button>
                                </div>
