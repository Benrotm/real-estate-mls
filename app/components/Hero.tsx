...
export default function Hero() {
    return (
        <div className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 pt-20 pb-4 md:pt-28 md:pb-8 overflow-hidden">
            {/* Background Decor */}
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <h1 className="text-2xl sm:text-4xl md:text-6xl font-bold text-white mb-3 tracking-tight leading-tight" style={{ textShadow: '0 0 40px rgba(0,0,0,0.8), 0 4px 20px rgba(0,0,0,0.5)' }}>
                ...
                <p className="text-xs sm:text-lg md:text-xl text-white mb-6 max-w-2xl mx-auto leading-relaxed font-medium" style={{ textShadow: '0 2px 20px rgba(0,0,0,0.8)' }}>
                ...
                {/* Action Button */}
                <div className="max-w-[180px] sm:max-w-xs mx-auto mb-6">
                    <Link href="/properties" className="w-full bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white py-2 px-4 sm:py-3.5 sm:px-8 rounded-xl font-bold text-xs sm:text-lg transition-all hover:scale-105 flex items-center justify-center gap-1.5 sm:gap-2 shadow-2xl shadow-cyan-500/50 border-2 border-cyan-300">
