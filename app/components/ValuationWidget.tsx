...
import { Lock, TrendingUp, Info, CheckCircle, BarChart3, Star, Home, ArrowUpRight, Sofa, Building, Layers, Search, Wind, Sun, DollarSign, Zap, User, Users, MapPin, Activity, ChevronDown, ChevronUp, Clock, List, Heart, Ban, Wallet, Smartphone, Mail, MessageSquare, Target, Calculator, Navigation, Award } from 'lucide-react';
        ...
        <div className="bg-white rounded-3xl border border-gray-200 shadow-xl overflow-hidden my-8 scroll-mt-24 relative" id="valuation">
            ...
            <div className="p-0 relative">
                ...
                <div className={userPlan === 'free' ? 'filter blur-md select-none opacity-20 p-8' : 'p-8'}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        <div className="bg-white border border-gray-100 p-6 rounded-2xl shadow-sm relative overflow-hidden group">
                            <div className="relative z-10">
                                ...
                                <h3 className="text-4xl font-black text-slate-900">{formatPrice(valuation.estimatedValue)}</h3>
                                <div className="flex items-center gap-2 mt-4">
                                    <div className={`h-2.5 w-2.5 rounded-full ${valuation.confidenceScore > 80 ? 'bg-emerald-500 shadow-sm' : 'bg-yellow-500'}`} />
                        ...
                        <div className="bg-white border border-gray-100 p-6 rounded-2xl shadow-sm relative overflow-hidden group col-span-2 grid grid-cols-2 gap-6">
                            <div className="relative z-10 flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-[10px] text-slate-400 font-black uppercase tracking-widest">Air Quality</p>
                                    <p className="text-lg font-bold text-slate-900 leading-tight">{valuation.lifestyleFactors.aqi.category}</p>
                                    <div className="flex items-center gap-1.5 mt-1">
                                        <div className="text-[10px] px-1.5 py-0.5 rounded bg-emerald-50 text-emerald-600 font-bold border border-emerald-100">
                            ...
                            <div className="relative z-10 flex items-center gap-4">
                                ...
                                <div>
                                    <p className="text-[10px] text-slate-400 font-black uppercase tracking-widest">Solar Potential</p>
                                    <p className="text-lg font-bold text-slate-900 leading-tight">{valuation.lifestyleFactors.solar.score}/100</p>
                                    <div className="flex items-center gap-1.5 mt-1">
                                        <div className="text-[10px] px-1.5 py-0.5 rounded bg-orange-50 text-orange-600 font-bold border border-orange-100">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        {valuation.amenityScore > 0 && (
                            <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm relative overflow-hidden group">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                                {valuation.amenityBreakdown
                                                    ...
                                                    .map((item: any, idx: number) => (
                                                        <div key={idx} className="flex justify-between items-center bg-gray-50 px-3 py-2.5 rounded-xl border border-gray-100 text-sm hover:bg-gray-100 transition-colors group">
                                                            <span className="text-slate-700 font-medium">{item.label}</span>
                                                            <span className="text-emerald-600 font-black">+{item.points}</span>
                                                        </div>
                                                    ))}
                                            </div>
                                        </div>
                                ...
                                <div className="mt-6 pt-4 border-t border-gray-200 flex items-center gap-2 text-[10px] text-slate-500 font-bold uppercase tracking-widest italic">
                    ...
                    <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm relative overflow-hidden flex flex-col h-full">
                        <div className="flex justify-between items-center mb-6 relative z-10">
                            <h4 className="text-lg font-bold text-slate-900 flex items-center gap-2">
                                <Home className="w-5 h-5 text-indigo-500" />
                                Recent Comparables
                            </h4>
                            <div className="text-[10px] font-black text-indigo-600 bg-indigo-50/50 border border-indigo-100 px-2 py-1 rounded-full uppercase tracking-widest">
                                MEDIAN: {formatPrice(medianPrice)}
                            </div>
                        </div>

                        {/* Price Distribution Graphic */}
                        <div className="bg-gray-50 border border-gray-100 rounded-xl p-5 mb-8 relative z-10">
                                ...
                                <ResponsiveContainer width="100%" height="100%">
                                    <ScatterChart margin={{ top: 10, right: 10, left: 10, bottom: 0 }}>
                                        <XAxis
                                            ...
                                            axisLine={false}
                                            tickLine={false}
                                            tick={{ fill: '#94a3b8', fontSize: 9, fontWeight: 'black' }}
                                        ...
                                        <Tooltip
                                            ...
                                            content={({ active, payload }) => {
                                                if (active && payload && payload.length) {
                                                    return (
                                                        <div className="bg-white px-2 py-1 border border-gray-200 rounded shadow-xl text-[10px] font-black text-slate-900">
                                        ...
                                        />
                                        <Scatter data={scatterData} fill="#94a3b8" shape="circle" />
                                    </ScatterChart>
                                </ResponsiveContainer>
                                <div className="absolute inset-x-0 bottom-[14px] h-[1px] bg-gray-200 mx-2"></div>
                            </div>
                        ...
                        <div className="flex-1 space-y-3 overflow-y-auto pr-2 custom-scrollbar max-h-[600px] relative z-10">
                            {valuation.comparables.map((comp: any) => (
                                <div key={comp.id} className="flex flex-col p-4 bg-gray-50 border border-gray-100 rounded-xl hover:bg-gray-100 transition-all group">
                                    <div className="flex justify-between mb-2">
                                        <span className="font-black text-slate-900">{formatPrice(Number(comp.sold_price))}</span>
                                    ...
                                    <div className="text-slate-600 text-xs truncate font-medium group-hover:text-slate-700 transition-colors">
                ...
                <div className="mt-12 pt-12 border-t border-gray-200">
                    {matchingLeads.length === 0 ? (
                        <div className="bg-gray-50 rounded-3xl border-2 border-dashed border-gray-200 p-12 text-center">
                            ...
                            <h5 className="font-bold text-slate-700">No Matched Leads Found</h5>
                        ...
                        return (
                            <div className="bg-white border border-gray-100 rounded-3xl p-8 shadow-xl relative overflow-hidden group">
                                ...
                                <div className="flex justify-between items-center mb-8 relative z-10">
                                    <div>
                                        <h4 className="text-2xl font-black text-slate-900 flex items-center gap-3">
                                            <Zap className="w-8 h-8 text-orange-500 fill-orange-500/20 animate-pulse" />
                                            Potential Buyers
                                        </h4>
                                        <p className="text-sm text-slate-500 font-medium">Verified leads matching this property's unique profile</p>
                                    </div>
                                    <div className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-xl shadow-inner">
                                        <Users className="w-4 h-4 text-indigo-500" />
                                        <span className="text-sm font-black text-slate-900">{matchingLeads.length} Matching</span>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-10 relative z-10">
                                        ...
                                        <div className="flex justify-between items-center mb-6">
                                            ...
                                            <div className="flex gap-6">
                                                <div className="text-center">
                                                    ...
                                                    <p className="text-sm font-black text-slate-900">{formatPrice(minBudget)}</p>
                                                </div>
                                                <div className="text-center relative px-4">
                                                    <div className="absolute inset-x-0 top-0 bottom-0 bg-indigo-500/10 blur-[10px] rounded-full" />
                                                    <span className="text-[10px] font-black text-indigo-600 uppercase tracking-widest relative z-10">Median</span>
                                                    <p className="text-sm font-black text-slate-900 relative z-10">{formatPrice(medianBudget)}</p>
                                                </div>
                                                <div className="text-center">
                                                    <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Max</span>
                                                    <p className="text-sm font-black text-slate-900">{formatPrice(maxBudget)}</p>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <ScatterChart margin={{ top: 20, right: 40, left: 40, bottom: 20 }}>
                                                    ...
                                                    <Tooltip
                                                        ...
                                                        content={({ active, payload }) => {
                                                            if (active && payload && payload.length) {
                                                                return (
                                                                    <div className="bg-white text-slate-900 px-3 py-2 border border-gray-200 shadow-xl rounded-lg text-xs font-black">
                                    ...
                                    {/* Lead List Table */}
                                    <div className="bg-gray-50 border border-gray-100 rounded-2xl overflow-hidden shadow-xl group/table">
                                        <div
                                            className="bg-white border-b border-gray-200 px-6 py-5 flex justify-between items-center cursor-pointer hover:bg-gray-100 transition-all"
                                            onClick={() => setIsTableExpanded(!isTableExpanded)}
                                        >
                                            <div className="grid grid-cols-[1.5fr,1fr,1fr,1fr,100px] gap-4 w-full">
                                                <div className="flex items-center gap-3">
                                                    <div className="bg-indigo-50/50 text-indigo-600 text-[10px] font-black px-2.5 py-1 rounded-full border border-indigo-100">
                                                        {matchingLeads.length}
                                                    </div>
                                                    <div className="text-[10px] font-black text-slate-900 uppercase tracking-[0.2em]">Qualified Leads</div>
                                                </div>
                                                ...
                                                <div className="flex items-center gap-2 justify-end">
                                                    <span className="text-[10px] font-bold text-slate-500 uppercase">{isTableExpanded ? 'Collapse' : 'Expand'}</span>
                                                    {isTableExpanded ? <ChevronUp className="w-5 h-5 text-slate-900" /> : <ChevronDown className="w-5 h-5 text-indigo-500 group-hover:translate-y-0.5 transition-transform" />}
                                                </div>
                                            </div>
                                        </div>
                                        {isTableExpanded && (
                                            <div className="overflow-x-auto border-t border-gray-200 animate-in slide-in-from-top-2 duration-300">
                                                        ...
                                                        {matchingLeads.map((lead: any, index: number) => (
                                                            <Fragment key={lead.id}>
                                                                <div
                                                                    ...
                                                                    className={`cursor-pointer transition-all grid grid-cols-[1.5fr,1fr,1fr,1fr,100px] gap-4 items-center px-6 py-5 border-b border-gray-200 last:border-none ${expandedLeadId === lead.id ? 'bg-indigo-50/50' : 'hover:bg-gray-100'}`}
                                                                >
                                                                    <div className="flex items-center gap-4">
                                                                        <div className="w-9 h-9 rounded-xl bg-gray-100 border border-gray-200 text-indigo-600 flex items-center justify-center text-xs font-black shadow-sm">
                                                                            BY
                                                                        </div>
                                                                        <div>
                                                                            <div className="font-bold text-slate-900 group-hover:text-indigo-600 transition-colors">Buyer #{index + 1}</div>
                                                                            <div className="text-[10px] text-slate-500 uppercase font-black tracking-widest">{lead.preference_type || 'Private Investor'}</div>
                                                                        </div>
                                                                    </div>
                                                                    <div className="text-center">
                                                                        <div className={`inline-block px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest ${lead.match_score >= 80 ? 'bg-emerald-50/50 text-emerald-600 border border-emerald-100' : 'bg-orange-50/50 text-orange-600 border border-orange-100'}`}>
                                                                            {lead.match_score}% Match
                                                                        </div>
                                                                    </div>
                                                                    <div className="font-black text-slate-900 text-center text-base tracking-tight">
                                                                        {formatPrice(lead.budget_max || 0)}
                                                                    </div>
                                                                    <div className="text-center">
                                                                        <span className={`text-[10px] font-black px-2 py-0.5 rounded uppercase tracking-[0.1em] ${lead.move_urgency === 'High' ? 'bg-rose-50/50 text-rose-600 border border-rose-100' : 'text-slate-500'}`}>
                                                                            {lead.move_urgency || 'Normal'}
                                                                        </span>
                                                                    </div>
                                                                    <div className="text-right flex justify-end pr-2">
                                                                        {expandedLeadId === lead.id ? <ChevronUp className="w-5 h-5 text-indigo-600" /> : <ChevronDown className="w-5 h-5 text-slate-500 group-hover:text-slate-700 transition-colors" />}
                                                                    </div>
                                                                </div>
                                                                {expandedLeadId === lead.id && (
                                                                    <div className="bg-gray-100 p-6 border-b border-gray-200">
                                                                        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden animate-in fade-in slide-in-from-top-4 duration-300">
                                                                            {/* Profile Header */}
                                                                            <div className="bg-gray-50 p-6 text-slate-900 flex justify-between items-center border-b border-gray-200">
                                                                                <div className="flex items-center gap-4">
                                                                                    <div className="w-12 h-12 rounded-xl bg-indigo-50/50 text-indigo-600 flex items-center justify-center text-xl font-black border border-indigo-100">
                                                                                        B
                                                                                    </div>
                                                                                    <div>
                                                                                        <h5 className="font-bold text-lg text-slate-900">Buyer #{index + 1}</h5>
                                                                                ...
                                                                                <div className="text-right">
                                                                                    <div className="text-[10px] font-black uppercase tracking-widest text-slate-500 mb-1">Engagement Score</div>
                                                                            ...
                                                                            <div className="p-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 bg-gray-50">
                                                                                ...
                                                                                <div className="space-y-6">
                                                                                    ...
                                                                                    <div className="space-y-4">
                                                                                        <div>
                                                                                            ...
                                                                                            <div className="text-sm font-bold text-slate-700">{lead.occupation || 'Executive / Professional'}</div>
                                                                                        </div>
                                                                                        <div>
                                                                                            <label className="block text-[10px] font-bold text-slate-500 uppercase">Marital Status</label>
                                                                                            <div className="text-sm font-bold text-slate-700">{lead.marital_status || 'Married'} • {lead.kids_count || 0} Kids</div>
                                                                                        </div>
                                                                                        <div>
                                                                                            <label className="block text-[10px] font-bold text-slate-500 uppercase">Living Situation</label>
                                                                                            <div className="text-sm font-bold text-slate-700">{lead.living_situation || 'Private Residence'}</div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div className="space-y-6">
                                                                                    <div className="flex items-center gap-2 border-b border-gray-200 pb-3">
                                                                                        ...
                                                                                        <h6 className="font-black text-slate-900 text-[10px] uppercase tracking-widest">Search Scope</h6>
                                                                                    </div>
                                                                                    <div className="space-y-4">
                                                                                        <div>
                                                                                            <label className="block text-[10px] font-bold text-slate-500 uppercase">Listing Type</label>
                                                                                            <div className="text-sm font-bold text-slate-700">{lead.preference_listing_type} {lead.preference_type}</div>
                                                                                        </div>
                                                                                        <div>
                                                                                            <label className="block text-[10px] font-bold text-slate-500 uppercase">Target Area</label>
                                                                                            <div className="text-sm font-bold text-slate-700 flex items-center gap-1"><MapPin className="w-3 h-3" /> {lead.preference_location_city || 'Regional'}</div>
                                                                                        </div>
                                                                                        <div>
                                                                                            <label className="block text-[10px] font-bold text-slate-500 uppercase">Size Preference</label>
                                                                                            <div className="text-sm font-bold text-slate-700">{lead.preference_rooms_min || 3} Rooms • {lead.preference_surface_min || 80}m²+</div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                ...
                                                                                <div className="space-y-6">
                                                                                    <div className="flex items-center gap-2 border-b border-gray-200 pb-3">
                                                                                        ...
                                                                                        <h6 className="font-black text-slate-900 text-[10px] uppercase tracking-widest">Purchase Intent</h6>
                                                                                    </div>
                                                                                    <div className="space-y-4">
                                                                                        <div>
                                                                                            <label className="block text-[10px] font-bold text-slate-500 uppercase">Primary Motivation</label>
                                                                                            <div className="inline-flex items-center gap-1.5 px-2 py-1 bg-gray-100 text-slate-700 rounded-md text-[10px] font-bold border border-gray-200">
                                                                                                <Heart className="w-3 h-3 text-rose-500 fill-current" /> {lead.buying_reason || 'Personal Living'}
                                                                                            </div>
                                                                                        </div>
                                                                                        <div>
                                                                                        ...
                                                                                        <div>
                                                                                            ...
                                                                                            <div className="text-sm font-black text-rose-500">{lead.move_urgency || 'Market Standard'}</div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div className="p-8 pt-4 grid grid-cols-1 md:grid-cols-2 gap-4 bg-gray-50">
                                                                                {lead.social_notes && (
                                                                                    <div className="bg-indigo-50 p-4 rounded-xl border border-indigo-100">
                                                                                        <div className="flex items-center gap-2 mb-2">
                                                                                            <Star className="w-3 h-3 text-indigo-500 fill-current" />
                                                                                            <span className="text-[10px] font-black text-indigo-500 uppercase tracking-widest">Strategic Preferences</span>
                                                                                        </div>
                                                                                        <p className="text-sm text-slate-700 font-medium italic">"{lead.social_notes}"</p>
                                                                                    </div>
                                                                                )}
                                                                                {lead.negative_preferences && (
                                                                                    <div className="bg-rose-50 p-4 rounded-xl border border-rose-100">
                                                                                        <div className="flex items-center gap-2 mb-2">
                                                                                            ...
                                                                                            <span className="text-[10px] font-black text-rose-500 uppercase tracking-widest">Restraints</span>
                                                                                        </div>
                                                                                        <p className="text-sm text-slate-700 font-medium italic">"{lead.negative_preferences}"</p>
                                                                                    </div>
                                                                                )}
                                                                            </div>
                                                                        </div>
