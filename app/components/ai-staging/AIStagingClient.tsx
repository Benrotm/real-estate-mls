...
import { 
  ...
  Sparkles, CheckCircle2, Sliders, Image as ImageIcon, Camera, Building, Sofa, Loader2
} from 'lucide-react';
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div className="bg-black/30 rounded-2xl border border-white/10 flex items-center justify-center p-6 min-h-[400px] relative overflow-hidden">
        {result ? (
           <img src={result} alt="Staging Result" className="w-full h-full object-contain rounded-xl" />
        ) : (
...
function Plan3DTool() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div className="bg-black/30 rounded-2xl border border-white/10 flex items-center justify-center p-6 min-h-[400px]">
        {result ? (
           <img src={result} alt="3D Plan Result" className="w-full h-full object-contain rounded-xl" />
        ) : (
           <div className="text-center">
             {isPending ? (
                 <>
